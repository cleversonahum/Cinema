...
public class TelaPrincipal extends javax.swing.JFrame{
    ...
    //Instancia a Classe Funcionario para pegar seu nome
    ...
    private void initComponents() {
        ...
        Sala5_Snoopy.setBounds(370, 180, 110, 150);
        ...
        Sala6_ORegressoLeg.setBounds(220, 180, 110, 150);
        ...
        ORegressoLeg.setBounds(214, 320, 130, 40);
        ...
        Snoopy.setBounds(350, 320, 200, 40);
        jPanelQuadradoInterno.add(jPanel1);
        jPanel1.setBounds(50, 200, 100, 20);

        QuadradoInterno.getContentPane().add(jPanelQuadradoInterno);
        jPanelQuadradoInterno.setBounds(0, 30, 670, 370);
        ...
        QuadradoInterno.setBounds(0, 0, 670, 440);
        ...
        FundoPrincipal.setBounds(0, 0, 670, 420);
        ...
        setSize(new java.awt.Dimension(689, 481));
